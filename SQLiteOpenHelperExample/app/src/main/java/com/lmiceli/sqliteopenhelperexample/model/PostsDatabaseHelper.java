package com.lmiceli.sqliteopenhelperexample.model;
...
/**
 * Often a SQLite database will be used across your entire application; within services,
 * applications, fragments, and more. For this reason, best practices often advise you to apply the
 * singleton pattern to your SQLiteOpenHelper instances to avoid memory leaks and unnecessary
 * reallocations. The best solution is to make your database instance a singleton instance across
...
public class PostsDatabaseHelper extends SQLiteOpenHelper {
    ...
    /**
     * Constructor should be private to prevent direct instantiation. Make a call to the static
